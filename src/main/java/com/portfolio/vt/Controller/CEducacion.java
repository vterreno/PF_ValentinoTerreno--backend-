...
import com.portfolio.vt.Dto.dtoEducacion;
import com.portfolio.vt.Entity.Educacion;
import com.portfolio.vt.Security.Controller.Mensaje;
import com.portfolio.vt.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getAnio()
            );
